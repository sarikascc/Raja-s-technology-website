...
export const TestimonialStack = ({
  ...
  }, [autoplay, autoplayDelay, isDragging, isHovering, pauseOnHover, totalCards]);

  if (!testimonials?.length) return null;

  return (
    <section
      className="testimonials-stack relative pb-10"
        ...
        return (
          ...
          >
            <div className="p-6 md:p-8">
              ...
              <blockquote className="text-black leading-relaxed text-lg mb-6">
